...
// let a = 67328783984598349398563495354n;
...
// }
    // if (prompt("Введите ваш воззраст") >=16) {
    ...
    // if (age < 16) {
    //     alert(`У Вас нет возможности учится длф получения вщдительских прав. Обратите через ${
    //         16 - age
    //     } год(а)`
    // );
    // }

    // if (+prompt("Введите Ваш возраст")> ) {
    //     alert("Приходите в нашу автошколу");
    // }else {
    //     alert("Нужно еше подрасти")
    // }
